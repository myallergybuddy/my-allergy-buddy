      ...
      body: SafeArea(
          ...
          padding: const EdgeInsets.all(24),
              ...
              _bulletList([
                ...
                'Call emergency services through the App only if you are experiencing an allergic reaction or another genuine medical emergency',
              ]),
              ...
              _bulletList([
                ...
                'Relationship labels you assign to those contacts',
              ]),
              _sectionBody('You may store up to 2 emergency contacts on the free plan, or up to 10 emergency contacts with Premium. This information is stored locally on your device to enable emergency features you choose to use. Emergency service calls and emergency SMS messages initiated through the App are unlimited on every plan.'),
              ...
              _sectionBody('My Allergy Buddy includes optional emergency features that you may choose to use. Free users may save up to 2 emergency contacts. Premium users may save up to 10 emergency contacts. Emergency service calls and emergency SMS messages initiated through the App are unlimited on every plan.'),
              ...
              _sectionBody('You should only use the emergency services call button if you are experiencing an allergic reaction or another genuine medical emergency. Do not use it to test the App or for non-emergency situations. Misuse of emergency numbers can delay help for others and may be unlawful.'),
