      ...
      body: SafeArea(
          ...
          padding: const EdgeInsets.all(24),
              ...
              _bulletList([
                ...
                'Optional passcode you configure (stored locally on your device)',
              ...
              _bulletList([
                'Passcodes you set may be encrypted (e.g. AES-256) and stored locally on your device (SharedPreferences and related secure storage where applicable)',
                'A passcode lock preference may be saved in settings; biometric unlock is not currently implemented in the app (no device biometric authentication is performed by the app)',
              ]),
              ...
              _bulletList([
                ...
                'Manage premium or subscription state via the app store and, when configured, the RevenueCat SDK',
                'Store optional passcode settings locally when you configure them',
              ]),
              ...
              _bulletList([
                'SMS may be used to reach your emergency contacts when you choose to use those features',
                'Messages may include your location link if you grant permission and initiate the action',
                'Emergency dialling shortcuts (e.g. 000 in Australia) place a call only after you confirm; the app does not automatically dispatch emergency services',
              ...
              _bulletList([
                ...
                'RevenueCat (subscription verification SDK)—processes purchase and entitlement data when the app is configured with valid API keys; see https://www.revenuecat.com/privacy',
              ...
              _bulletList([
                'When you use emergency features, information you choose to send (e.g. location link, message content) is shared with the recipients you select (such as your emergency contacts)',
                'The app does not automatically dispatch or transmit data to emergency services on your behalf',
              ...
              _bulletList([
                ...
                'Disable notifications in the app or system settings',
