        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _sectionBody('My Allergy Buddy helps users identify potential allergens in food products by scanning product labels and barcodes.'),
              _subSection('Limitations:'),
              _bulletList([
                'This app does not provide medical advice, diagnosis, or treatment',
                'It cannot detect trace allergens or cross-contamination',
                'It does not guarantee ingredient label accuracy or completeness',
                'Use is entirely at your own risk',
              ]),
              _sectionTitle('3. Cross-Contamination Disclaimer'),
              _bulletList([
                'This app cannot detect or warn about:',
                'Trace allergens or "may contain" risks',
                'Cross-contamination from production environments',
                'Allergen exposure not explicitly listed on packaging',
              ]),
              ...
              _bulletList([
                'Used only when emergency features are manually triggered',
                'Shared via SMS with emergency contacts and/or emergency services',
                'Can be disabled via your device settings',
              ]),
              _subSection('b. SMS Functionality'),
              _bulletList([
                'Sends location-based alerts to select emergency contacts',
                'Standard carrier charges may apply',
              ]),
              _subSection('c. Emergency Services Integration'),
              _bulletList([
                'Includes emergency call shortcut to 000 (Australia only)',
                'Automatically sends predefined alert with location to contacts when triggered',
              ]),
              ...
              _bulletList([
                'Managed through the Google Play Store, powered by RevenueCat',
                'Subscriptions auto-renew unless cancelled before the renewal date',
                "Refunds follow Australian Consumer Law and Google Play's policies",
                'RevenueCat manages subscription status securely and accurately',
              ]),
              ...
              _bulletList([
                'Location is used temporarily for emergency response only',
                'Never collected in the background or without permission',
                'Location access can be turned off in device settings',
                'Data is deleted after use and not stored externally',
              ]),
              ...
              _bulletList([
                ...
                'Emergency services and allergy guidance require user judgment',
              ]),
